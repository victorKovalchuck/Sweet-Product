...
<body>
   ...
   <div id="lblMessage" class="Error" runat="server" visible="false"/>
    <div>     
    <asp:TextBox ID="txtUsername" CssClass="inputBE" runat="server" Placeholder="UserName"></asp:TextBox> <br />
    <asp:TextBox ID="txtPassword" CssClass="inputBE" runat="server" Placeholder="Password" TextMode="Password"></asp:TextBox>  <br />
