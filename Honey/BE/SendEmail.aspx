...
<asp:TextBox ID="txtSubject" CssClass="inputBE" Placeholder="Subject" runat="server" ValidationGroup="newProductGroup"></asp:TextBox>
...
<br />
<asp:TextBox ID="txtEmail" CssClass="inputBE" Placeholder="Email" TextMode="MultiLine" Width="100%" Height="100px" runat="server" ValidationGroup="newProductGroup"></asp:TextBox><br />
