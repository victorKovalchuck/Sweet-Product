<%@ Page Language="C#" MasterPageFile="~/BE/BeMaster.Master" AutoEventWireup="true" CodeBehind="NewTopic.aspx.cs" Inherits="Honey.BE.NewTopic" %>
...
<asp:Content ID="content2" runat="server" ContentPlaceHolderID="cntBody">
    ...
    <div>
        <honey:TopicControl ID="cntrlTopic" runat="server" Code="victor2" />
    </div>
</asp:Content>
